...
export default function LimitReached({
  ...
  return (
    <div
      data-testid={TEST_IDS.limit.container}
    ...
    >
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 w-full max-w-md text-center">
        ...
        <p className="text-slate-500 text-sm mb-6">
          Victorian Curriculum Mathematics — Years 7–9
        </p>

        <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 mb-6">
          <p
            data-testid={TEST_IDS.limit.message}
            className="text-amber-800 font-medium mb-2"
          >
            You've completed your {sessionsToday} sessions for today!
          </p>
          <p
            data-testid={TEST_IDS.limit.resetTime}
        ...
        <button
          data-testid={TEST_IDS.limit.unlockBtn}
          onClick={() => {
        ...
        <button
          ...
          data-testid={TEST_IDS.limit.historyBtn}
        ...
        <p className="text-xs text-slate-400 mt-4">
          Not ready to subscribe? We'd still love to hear from you —{" "}
          <a
