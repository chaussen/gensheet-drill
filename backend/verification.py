...
class VerificationEngine:
    ...
    def _registry(self):
        return {
            ...
            "T-7M-04b": self._angle_relationship,
    ...
    def curated_template_ids(self):
        ...
        return {
            ...
            # to fall back to _distractors_off_by_one, producing nonsensical string distractors.
            # Pre-existing bug from docs/verification.py — do not fix without explicit instruction.
            "T-9ST-03"
        }
